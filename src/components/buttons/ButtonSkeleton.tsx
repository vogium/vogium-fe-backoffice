...
import { IButtonSkeleton } from "../../types/IButton";
...
export default function ButtonSkeleton({
  ...
  let buttonClassName =
    "flex justify-center gap-5 w-full font-semibold py-1 px-4 border-2 rounded animation-smooth-fast tracking-wider ";
  ...
  buttonClassName = cn(
    buttonClassName,
    isBlockState ? " cursor-not-allowed " : " cursor-pointer ",
    className
  );
